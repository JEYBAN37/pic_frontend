        ...
        <footer  id="Contacto" className="flex flex-col items-center justify-center bg-gray-300 py-6">
            <div className='w-full flex flex-row justify-between'>
                <div className='flex flex-col items-start justify-center'>
                    ...
                    <h3 className="text-xl font-bold text-green-600 px-10 py-2">{footerData.titleContact}</h3>
                ...
                <div className='flex flex-col items-end justify-start'>
                    <div className='text-xl font-bold text-green-600 px-10 text-end'>Siguenos</div>
